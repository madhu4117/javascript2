...
const calculateSalary = (basicSalary, bonusPercentage) => {
  const employeeName = "Madhu sudhanan";
  const employeeID = "SKT-26-0947";
...
//ANSWER:  The var is function scoped and can be re-declared and updated, let is block scoped and can be updated but not re-declared, const is block scoped and cannot be updated or re-declared.